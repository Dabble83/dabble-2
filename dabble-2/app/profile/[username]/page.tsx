  ...
  return (
    <div className="pb-16 md:pb-20">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-8">
            <div className="relative h-24 w-24 shrink-0 overflow-hidden rounded-full border-2 border-[var(--border)] bg-[var(--surface)] shadow-sm">
              {avatarUrl && !avatarBroken ? (
                ...
                <div className="flex h-full w-full items-center justify-center bg-[var(--brand)] font-sans text-2xl font-semibold text-white">
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <p className="font-sans text-sm text-[var(--text-tertiary)]">@{username}</p>
              {experienceLine ? (
        ...
        {(profile?.interests_intro || profile?.skills_intro) && (
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
            {profile?.interests_intro ? (
              <Card title="Curious in their own words">
                <p className="font-serif text-base leading-relaxed text-[var(--text-secondary)]">
                  {profile.interests_intro}
                </p>
              </Card>
      ...
      {sessionSheetOpen ? (
        ...
        >
          <div role="dialog" aria-modal="true" aria-labelledby="session-sheet-title" onClick={(e) => e.stopPropagation()}>
            <Card title="Sessions coming soon" className="max-w-md">
              <p className="font-serif text-base leading-relaxed text-[var(--text-secondary)]">
